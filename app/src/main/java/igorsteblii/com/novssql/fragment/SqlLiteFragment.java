...
public class SqlLiteFragment extends BaseFragment {
    ...
    private Gson mGson;
    private DataBaseTableOpenHelper mDbOpenHelper;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mDbOpenHelper = new DataBaseTableOpenHelper(getActivity());
        mDbOpenHelper.addDateIfDoNotExist();
    ...
    protected void selectComplex() {
        ...
        List<Song> list = mDbOpenHelper.selectComplex();
    ...
    protected void selectAll() {
        long time = System.currentTimeMillis();
        ArrayList<Song> allSongs = mDbOpenHelper.getAllSongs();
        long time2 = System.currentTimeMillis() - time;
    ...
    protected void addFromJson() {
        ...
        Song[] song = mGson.fromJson(jsonSonArray.toString(), Song[].class);
        long time1 = System.currentTimeMillis() - time;
        time = System.currentTimeMillis();
        mDbOpenHelper.addAll(Arrays.asList(song));
        long time2 = System.currentTimeMillis() - time;
